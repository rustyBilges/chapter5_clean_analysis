...
def plot_map(AX, fname, mmin=0,mmax=1, annot='A', xoff=False,yoff=False, xlab='None', ylab='None', aspect=False, row_lab=None, col_lab=None):
...
plot_map(AX[1], 'tot_map_mai_0'+strad+'.csv', mmax=54000, xoff=True,yoff=True, col_lab='Individuals', annot='B') 
plot_map(AX[2], 'div_map_mai_0'+strad+'.csv', mmax=1, xoff=True, yoff=True, col_lab='Diversity', annot='C') 
plot_map(AX[3], 'ext_map_mai_0.5'+strad+'.csv', mmax=30, xoff=True, row_lab = 'MAI = 0.5', ylab='immigration', annot='D')
plot_map(AX[4], 'tot_map_mai_0.5'+strad+'.csv', mmax=54000, xoff=True,yoff=True, annot='E')
plot_map(AX[5], 'div_map_mai_0.5'+strad+'.csv', mmax=1, xoff=True, yoff=True, annot='F') 

plot_map(AX[6], 'ext_map_mai_1.0'+strad+'.csv', mmax=30, xlab='habitat loss', ylab='immigration', annot='G', row_lab='MAI = 1.0')
plot_map(AX[7], 'tot_map_mai_1.0'+strad+'.csv', mmax=54000, xlab='habitat loss', yoff=True, annot='H')
plot_map(AX[8], 'div_map_mai_1.0'+strad+'.csv', mmax=1, xlab='habitat loss', yoff=True, annot='I')
